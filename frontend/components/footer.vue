...
<template>
  <footer class="flex flex-col w-full space-y-8 dark:text-custom-cyan text-custom-dark pt-8">
    ...
    -->
        ...
        <h2 class="font-medium text-xl">Vootaa.com</h2>
      </div>
      <section class="flex space-x-8">
        <h3 class="sr-only">Social media</h3>
        <a href="" target="_blank" rel="noopener noreferrer">
          <UIcon name="grommet-icons:x" class="w-8 h-8 dark:bg-custom-cyan bg-custom-dark"/>
        </a>
        <a href="" target="_blank" rel="noopener noreferrer">
          <UIcon name="grommet-icons:github" class="w-8 h-8 dark:bg-custom-cyan bg-custom-dark"/>
        </a>
        <a href="" target="_blank" rel="noopener noreferrer">
          <UIcon name="ic:baseline-discord" class="w-8 h-8 dark:bg-custom-cyan bg-custom-dark"/>
        </a>
      </section>
    </div>
    <div class="flex flex-row justify-between items-center">
      <p>@Vootaa Crypto, 2025</p>
      <p>
        Contact us:
        <a href="mailto:vootaa@gmail.com" class="underline-offset-2 underline">vootaa@gmail.com</a>
      </p>
    </div>
  </footer>
</template>
