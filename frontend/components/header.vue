...
-->
    ...
    <h1 class="text-custom-dark dark:text-custom-cyan">Vootaa</h1>
    <div class="flex ml-10 justify-between w-full">
      <nav class="flex items-center space-x-4">
        <ul class="flex flex-row space-x-8 text-custom-dark dark:text-custom-cyan">
          <li>
            <NuxtLink to="/swap" class="underline underline-offset-8">Swap</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/pool">Pool</NuxtLink>
          </li>
          <li>
            <NuxtLink to="/liquidity">Liquidity</NuxtLink>
          </li>
        </ul>
      </nav>
