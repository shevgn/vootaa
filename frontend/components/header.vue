...
<template>
  <header class="flex flex-row items-center">
    ...
    <svg class="mr-1 h-12 w-12" viewBox="0 0 500 500" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
-->
          <g id="logo-group" transform="translate(80, 42)" stroke-width="10">
            <path id="path" class="fill-custom-dark dark:fill-custom-cyan"
            ...
            <path id="circle" class="fill-custom-green stroke-white dark:stroke-custom-black"
            ...
            <rect id="box" class="fill-custom-dark dark:fill-custom-cyan"
              transform="translate(259.5939, 111.0703) rotate(20) translate(-259.5939, -111.0703)" x="214.593909"
              y="16.0702692" width="90" height="190" rx="45" />
          </g>
        </g>
      </g>
    </svg>
    <div class="flex w-full justify-between">
      <nav class="relative flex items-center">
        <ul class="flex flex-row items-center space-x-8 text-custom-dark dark:text-custom-cyan">
          <li class="mr-4">
            <NuxtLink to="/" class="text-xl">Vootaa</NuxtLink>
          </li>
          <li class="mr-4 border-b-2 border-custom-dark transition dark:border-custom-cyan" :class="path === '/pool'
              ? 'border-opacity-100 dark:border-opacity-100'
              : 'border-opacity-0 dark:border-opacity-0'
            ">
            <NuxtLink to="/pool" class="">Pool</NuxtLink>
          </li>
          <li class="mr-4 border-b-2 border-custom-dark transition dark:border-custom-cyan" :class="path === '/liquidity'
              ? 'border-opacity-100 dark:border-opacity-100'
              : 'border-opacity-0 dark:border-opacity-0'
            ">
            <NuxtLink to="/liquidity" class=""> Liquidity </NuxtLink>
          </li>
          <li class="mr-4 border-b-2 border-custom-dark transition dark:border-custom-cyan" :class="path === '/swap'
              ? 'border-opacity-100 dark:border-opacity-100'
              : 'border-opacity-0 dark:border-opacity-0'
            ">
      ...
      <div class="flex items-center space-x-4">
        <form action="" class="h-full">
          <input type="text" placeholder="input your K:account"
        ...
        <button
          ...
          <span class="text-sm text-custom-dark dark:text-custom-cyan lg:text-base">Connect to wallet</span>
        </button>
